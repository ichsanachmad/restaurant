...
import 'package:restaurant/utils/navigation/notification_navigation.dart';
...
class NotificationHelper {
  ...
  Future<void> showNotification(
    ...
    var restaurantName = "Visit " + (restaurant.name ?? "") + " Today!";
  ...
  void configureSelectNotificationSubject(String route) {
    selectNotificationSubject.stream.listen(
      (String payload) async {
        ...
        var restaurant = data;
        NotificationNavigation.intentWithData(route, restaurant);
      },
    );
  }
}
